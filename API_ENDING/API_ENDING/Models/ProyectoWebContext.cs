...
public partial class ProyectoWebContext : DbContext
{
    ...
    public virtual DbSet<Adjudicado> Adjudicado { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAdjudicado).HasName("PK__Adjudica__7B6F1B2688A14520");

            entity.ToTable("Adjudicado");

            entity.Property(e => e.IdAdjudicado)
                .ValueGeneratedNever()
                .HasColumnName("id_Adjudicado");
            ...
            entity.HasOne(d => d.oRemate).WithMany(p => p.oAdjudicado)
        ...
        {
            entity.HasKey(e => new { e.IdPropiedad, e.IdLitigioso, e.IdLitigio, e.IdAdjudicado }).HasName("PK__Incluye__7E003D0B490B07A5");
        ...
        {
            entity.HasKey(e => e.IdInmobiliaria).HasName("PK__Inmobili__C02F5BD6170FEFB0");

            entity.Property(e => e.IdInmobiliaria)
                .ValueGeneratedNever()
        ...
        {
            entity.HasKey(e => e.IdLitigio).HasName("PK__Litigio__86FC4C7D43CF0666");

            entity.ToTable("Litigio");

            entity.Property(e => e.IdLitigio)
                .ValueGeneratedNever()
                .HasColumnName("id_Litigio");
            ...
            entity.HasOne(d => d.oRemate).WithMany(p => p.oLitigio)
                .HasForeignKey(d => d.IdRemate)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.IdLitigioso).HasName("PK__Litigios__2CB95D65DC121A0A");

            entity.ToTable("Litigioso");

            entity.Property(e => e.IdLitigioso)
                .ValueGeneratedNever()
                .HasColumnName("id_Litigioso");
            entity.Property(e => e.Apellidos)
                .HasMaxLength(60)
                .IsUnicode(false)
                .HasColumnName("apellidos");
        ...
        {
            entity.HasKey(e => e.IdPropiedad).HasName("PK__Propieda__F23AE260F0676931");
        ...
        {
            entity.HasKey(e => e.IdRemate).HasName("PK__Remate__FB7BB6E188B0612F");

            entity.ToTable("Remate");

            entity.Property(e => e.IdRemate)
                .ValueGeneratedNever()
                .HasColumnName("id_Remate");
